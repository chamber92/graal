<div id="save-cross-way-modal" class="modal fade" tabindex="-1" data-backdrop="static" wire:ignore.self>
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ $crossWay && $crossWay->exists ? 'Update' : 'Create' }} Cross Way</h5>
